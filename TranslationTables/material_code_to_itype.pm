...
our $tableKirkas = {
    ...
    100004 => ['Moniste'],
    100005 => ['TY'],
    100006 => ['Aanikirja'], #jos MP3 → MP (< 10 kpl), hoidetaan käsipeleitse
    100007 => ['MO'],
    100011 => ['AL'],
    100012 => ['KR'],
    100013 => ['NU'],
    ...
    100023 => ['DI'],
    100024 => ['KU'],
    100025 => ['ES'], #jos lautapeli → PE (~ 59 kpl), hoidetaan käsipeleitse
    100026 => ['ATK-tallenne'],
    100027 => ['CR'], #jos $650a konsolipeli → KP (~ 48kpl), hoidetaan käsipeleitse
    100028 => ['Online'],
    100029 => ['DV'],
    100031 => ['KK'],
    100032 => ['MK'],
